...
void decodeFile(FILE* in, FILE* out) {
	...
	int sc = 0;
	struct letter *head = NULL, *temp1 = NULL, *temp2 = NULL;
	struct letter *curr;
...
////////////////////////////////////////////////////
struct letter* insert(struct letter* head, struct letter* left, struct letter* right, int value,unsigned long count) {
	struct letter*  newNode = createNode(value,count,left,right);
	int maxRightLeaf = furright(newNode);
	struct letter* lastNode,  *curr;
	int terminate;
	if(head == NULL)
		return newNode;
...
////////////////////////////////////////////////////////////////
struct letter* fill(struct letter* head,struct letter* left, struct letter* right, int value, unsigned long count) {
  	struct letter*  newNode = createNode(value,count,left,right);
  	struct letter* curr, *lastNode;
  	if(head == NULL)
    		return newNode;
  	else if(count < head->count) {
    		newNode->next = head;
...
////////////////////////////////////////////////////////////////
int furright(struct letter* node) {
  	if(node == NULL)
  		return 0;
...
////////////////////////////////////////////////////////////////
struct letter* createNode(int value,unsigned long count, struct letter* left, struct letter* right) {
